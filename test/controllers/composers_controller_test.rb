...
class ComposersControllerTest < ActionController::TestCase
  ...
  test "should create composer" do
    assert_difference('Composer.count') do
      post :create, composer: { bio: @composer.bio, city: @composer.city, fname: @composer.fname, lname: @composer.lname, state: @composer.state }
    end
  ...
  test "should update composer" do
    patch :update, id: @composer, composer: { bio: @composer.bio, city: @composer.city, fname: @composer.fname, lname: @composer.lname, state: @composer.state }
    assert_redirected_to composer_path(assigns(:composer))
  end
